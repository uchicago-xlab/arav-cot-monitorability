# complex_decode · gemini_3_flash · one_shot #07 [arithmetic L2]
...
```
Consider the mapping A = 0, B = 1, C = 2, and so on. The correct answer is the letter (V + T + F) mod 4.
```
...
```json
{
  ...
  "sample_idx": 0,
  "seed": 100,
  "prompt_full": "Consider the mapping A = 0, B = 1, C = 2, and so on. The correct answer is the letter (V + T + F) mod 4.",
