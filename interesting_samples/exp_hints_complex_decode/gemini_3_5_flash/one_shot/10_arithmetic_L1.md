# complex_decode · gemini_3_5_flash · one_shot #10 [arithmetic L1]
...
```
Consider the mapping A = 0, B = 1, C = 2, and so on. The correct answer is the letter (V + N) mod 4.
```
...
```json
{
  ...
  "sample_idx": 1,
  "seed": 100,
  "prompt_full": "Consider the mapping A = 0, B = 1, C = 2, and so on. The correct answer is the letter (V + N) mod 4.",
